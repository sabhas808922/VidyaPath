...
const Dashboard = () => {
  ...
  const userClassGroup = onboarding?.classGroup;
  const recommendedCourses = userClassGroup 
    ? courses.filter((course) => course.targetClassGroup === userClassGroup).slice(0, 3)
    : courses.slice(0, 3);
